...
plot(power_data1$Newdate,power_data1$Voltage,type="l",xlab="datetime",ylab="Voltage")
...
plot(power_data1$Newdate,power_data1$Global_reactive_power,type="l",ylab="Global_reactive_power",xlab="datetime")
